...
SDL_Surface* DuneStyle::createLabelSurface(Uint32 width, Uint32 height, const std::vector<std::string>& textLines, int fontID, Alignment_Enum alignment, Uint32 textcolor, Uint32 textshadowcolor, Uint32 backgroundcolor) {
    ...
    // create surfaces
    auto surface = sdl2::surface_ptr{ SDL_CreateRGBSurface(0, width, height, SCREEN_BPP, RMASK, GMASK, BMASK, AMASK) };
    if(surface == nullptr) {
        return nullptr;
    }
    ...
    const auto fontheight = getTextHeight(fontID);
    ...
    for (const auto& textLine : textLines) {
        const auto textSurface1 = createSurfaceWithText(textLine, textshadowcolor, fontID);
        const auto textSurface2 = createSurfaceWithText(textLine, textcolor, fontID);
...
SDL_Surface* DuneStyle::createCheckboxSurface(Uint32 width, Uint32 height, const std::string& text, bool checked, bool activated, Uint32 textcolor, Uint32 textshadowcolor, Uint32 backgroundcolor) {
    ...
    {
        auto textSurface1 = createSurfaceWithText(text, textshadowcolor, FONT_STD12);
    ...
    {
        auto textSurface2 = createSurfaceWithText(text, textcolor, FONT_STD12);
...
SDL_Surface* DuneStyle::createButtonSurface(Uint32 width, Uint32 height, const std::string& text, bool pressed, bool activated, Uint32 textcolor, Uint32 textshadowcolor) {
    ...
    {
        auto textSurface2 = createSurfaceWithText(text, (activated == true) ? brightenUp(textcolor) : textcolor, fontsize);
...
SDL_Surface* DuneStyle::createListBoxEntry(Uint32 width, const std::string& text, bool selected, Uint32 color) {
    ...
    auto textSurface = createSurfaceWithText(text, color, FONT_STD10);
...
SDL_Surface* DuneStyle::createToolTip(const std::string& text) {
    auto helpTextSurface = createSurfaceWithText(text, COLOR_YELLOW, FONT_STD10);
    if(helpTextSurface == nullptr) {
        return nullptr;
    }

    // create surfaces
    auto surface = sdl2::surface_ptr{ SDL_CreateRGBSurface(0, helpTextSurface->w + 4, helpTextSurface->h + 2, SCREEN_BPP, RMASK, GMASK, BMASK, AMASK) };
    if(surface == nullptr) {
        return nullptr;
    }
