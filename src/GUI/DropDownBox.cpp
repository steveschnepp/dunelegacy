...
DropDownBox::DropDownBox() {
    ...
    DropDownBox::resize(DropDownBox::getMinimumSize().x, DropDownBox::getMinimumSize().y);
}
...
void DropDownBox::resizeListBox() {
    auto listBoxHeight = std::max(1,std::min(numVisibleEntries,getNumEntries())) * static_cast<int>(GUIStyle::getInstance().getListBoxEntryHeight()) + 2;
